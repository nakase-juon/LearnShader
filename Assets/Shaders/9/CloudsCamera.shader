    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 raymarch(float3 cameraPos, float3 viewDir, fixed4 bgcol, float depth)
            {
                ...
                float ct = 0; //ステップ数のカウンター

                MARCH(_Steps, map1, cameraPos, viewDir, bgcol, color, depth, ct);
                MARCH(_Steps, map2, cameraPos, viewDir, bgcol, color, depth*2, ct);
                MARCH(_Steps, map3, cameraPos, viewDir, bgcol, color, depth*3, ct);
                MARCH(_Steps, map4, cameraPos, viewDir, bgcol, color, depth*4, ct);
                MARCH(_Steps, map5, cameraPos, viewDir, bgcol, color, depth*5, ct);
